...
class AcsPatientEvaluation(models.Model):
    ...
    # Examens Physiques (Physical Examination) fields
    tete = fields.Text(string='Tête', help="Head examination findings")
    cou = fields.Text(string='Cou', help="Neck examination findings")
    thorax = fields.Text(string='Thorax', help="Thorax examination findings")
    abdomen = fields.Text(string='Abdomen', help="Abdomen examination findings")
    msmi = fields.Text(string='MSMI', help="Upper and lower limbs examination findings")
    oge = fields.Text(string='OGE', help="External genitalia examination findings")
    traitement = fields.Text(string='Traitement', help="Treatment prescribed")
